      ...
      <div className="space-y-5">
        ...
        {tab === 'Feature' && (<>
          ...
          <SectionCard title="Feature Section — Background Image & Stats">
            <Field label="Background image URL" value={h.featureImage}
              onChange={(e:any)=>set('featureImage',e.target.value)} placeholder="https://…"/>
            {h.featureImage && (
              <img src={h.featureImage} alt="preview" className="w-full h-40 object-cover rounded-xl border border-gray-100"/>
            )}
            <div className="grid grid-cols-2 gap-4">
