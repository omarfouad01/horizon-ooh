/**
 * translations.ts — All static UI translation strings.
 * Extracted from LangContext.tsx to keep it out of the eager bundle.
 * Imported synchronously in LangContext (tree-shaken at build time).
 */
