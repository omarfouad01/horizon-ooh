  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="space-y-8 mt-6">
        ...
        {/* CTA Bar */}
        <section className="bg-white border border-gray-100 rounded-xl p-6 space-y-4">
          <h2 className="text-sm font-bold text-gray-900 uppercase tracking-widest">CTA Bar (Help Choosing)</h2>
          <Field label="CTA Button 1 — Help Choosing (EN)" value={d.ctaHelp ?? ''} onChange={e => set('ctaHelp', e.target.value)} placeholder="Help Me Choose" />
          <Field label="CTA Button 1 (AR)" value={d.ctaHelpAr ?? ''} onChange={e => set('ctaHelpAr', e.target.value)} dir="rtl" />
          <Field label="CTA Button 2 — Talk to Expert (EN)" value={d.ctaExpert ?? ''} onChange={e => set('ctaExpert', e.target.value)} placeholder="Talk to an Expert" />
          <Field label="CTA Button 2 (AR)" value={d.ctaExpertAr ?? ''} onChange={e => set('ctaExpertAr', e.target.value)} dir="rtl" />
