import{r as a,j as r}from"./react-core-D71apps3.js";import{L as t}from"./leaflet-DU5C8HEI.js";import{e as v}from"./admin-CvGGxn3H.js";import"./router-DmhmN6yl.js";import"./utils--BulIq_u.js";import"./app-core-C9xNrc0G.js";import"./data-layer-vtyzfh16.js";import"./site-data-DxKVQzcS.js";import"./icons-CqMiVHhk.js";import"./iconify-DfhjRUy6.js";const s="#0B0F1A",e="#D90429",b="#FFFFFF";function z(){return t.divIcon({html:`
      ...
      </div>`,className:"",iconSize:[40,52],iconAnchor:[20,52],popupAnchor:[0,-58]})}function T({lat:l,lng:c,name:p,type:f,district:d,city:u,traffic:x,size:h,className:g,style:y}){const i=a.useRef(null),n=a.useRef(null);return a.useEffect(()=>{if(v(),!i.current||n.current)return;const o=t.map(i.current,{center:[l,c],zoom:16,zoomControl:!1,attributionControl:!1,scrollWheelZoom:!1});t.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{maxZoom:19}).addTo(o),t.control.zoom({position:"bottomright"}).addTo(o);const m=t.marker([l,c],{icon:z(),zIndexOffset:1e3,title:p,alt:p}).addTo(o);return m.bindPopup(t.popup({maxWidth:260,minWidth:220,className:"horizon-product-popup",closeButton:!0,offset:[0,-8],autoClose:!1,closeOnClick:!1}).setContent(`
        <div style="font-family:'Inter',sans-serif;padding:2px">
          <p style="font-size:9px;font-weight:700;letter-spacing:.22em;text-transform:uppercase;color:${e};margin:0 0 5px">${f}</p>
          <p style="font-size:15px;font-weight:800;color:${s};margin:0 0 3px;line-height:1.15">${p}</p>
          <p style="font-size:11px;color:rgba(11,15,26,.4);margin:0 0 12px">${d}, ${u}</p>
          <div style="display:flex;gap:16px;border-top:1px solid rgba(11,15,26,.07);padding-top:10px">
            <div>
              ...
              <p style="font-size:12px;font-weight:700;color:${s};margin:0">${x.split(" ").slice(0,2).join(" ")}</p>
            </div>
            <div>
              ...
              <p style="font-size:12px;font-weight:700;color:${s};margin:0">${h}</p>
            </div>
          </div>
        </div>`)),m.openPopup(),o.on("click",()=>o.scrollWheelZoom.enable()),o.on("mouseout",()=>o.scrollWheelZoom.disable()),n.current=o,()=>{o.remove(),n.current=null}},[]),r.jsxs(r.Fragment,{children:[r.jsx("div",{ref:i,className:g,style:y}),r.jsx("style",{children:`
        @keyframes pinPulse {
