import{r as n,j as r}from"./react-core-BFdVlmMB.js";import{L as t}from"./leaflet-DU5C8HEI.js";import{e as v}from"./admin-Bu0oY5eW.js";import"./utils--BulIq_u.js";import"./router-BOoTkyjI.js";import"./icons-B-8HWK54.js";import"./data-layer-DlwazQWM.js";const a="#0B0F1A",e="#D90429",b="#FFFFFF";function z(){return t.divIcon({html:`
      ...
      </div>`,className:"",iconSize:[40,52],iconAnchor:[20,52],popupAnchor:[0,-58]})}function R({lat:s,lng:l,name:m,type:f,district:d,city:u,traffic:x,size:h,className:g,style:y}){const p=n.useRef(null),i=n.useRef(null);return n.useEffect(()=>{if(v(),!p.current||i.current)return;const o=t.map(p.current,{center:[s,l],zoom:16,zoomControl:!1,attributionControl:!1,scrollWheelZoom:!1});t.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{maxZoom:19}).addTo(o),t.control.zoom({position:"bottomright"}).addTo(o);const c=t.marker([s,l],{icon:z(),zIndexOffset:1e3}).addTo(o);return c.bindPopup(t.popup({maxWidth:260,minWidth:220,className:"horizon-product-popup",closeButton:!0,offset:[0,-8],autoClose:!1,closeOnClick:!1}).setContent(`
        <div style="font-family:'Inter',sans-serif;padding:2px">
          <p style="font-size:9px;font-weight:700;letter-spacing:.22em;text-transform:uppercase;color:${e};margin:0 0 5px">${f}</p>
          <p style="font-size:15px;font-weight:800;color:${a};margin:0 0 3px;line-height:1.15">${m}</p>
      ...
      `})]})}export{R as default};
//# sourceMappingURL=ProductMap-DjsbP2V1.js.map
