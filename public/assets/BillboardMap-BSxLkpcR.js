import{r as s,j as r}from"./react-core-D-bXyxDN.js";import"./admin-Krn15jlA.js";import{L as i}from"./leaflet-DcPNEzH4.js";import{a as y}from"./router-DwZDU_mQ.js";import"./utils-B2rm_Apj.js";import"./data-layer-Dd3l1QeK.js";const p="#0B0F1A",l="#D90429",x="#FFFFFF";delete i.Icon.Default.prototype._getIconUrl;i.Icon.Default.mergeOptions({iconUrl:"https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon.png",iconRetinaUrl:"https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon-2x.png",shadowUrl:"https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png"});function v(o=!1){const c=o?l:p,n=o?x:l;return i.divIcon({html:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="36" viewBox="0 0 32 40">
    ...
    </svg>`,className:"",iconSize:[28,36],iconAnchor:[14,36],popupAnchor:[0,-40]})}function E({filtered:o,allCount:c,selected:n,onSelect:d,className:h,style:w}){y();const f=s.useRef(null),m=s.useRef(null),g=s.useRef([]);return s.useEffect(()=>{if(!f.current||m.current)return;const e=i.map(f.current,{center:[30.0444,31.2357],zoom:7,zoomControl:!1,attributionControl:!1});return i.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{maxZoom:19}).addTo(e),i.control.zoom({position:"bottomright"}).addTo(e),m.current=e,()=>{e.remove(),m.current=null}},[]),s.useEffect(()=>{const e=m.current;e&&(g.current.forEach(t=>t.remove()),g.current=[],o.forEach(t=>{const u=(n==null?void 0:n.id)===t.id,a=i.marker([t.lat,t.lng],{icon:v(u),zIndexOffset:u?1e3:0}).addTo(e);a.on("click",()=>d((n==null?void 0:n.id)===t.id?null:t)),a.bindPopup(i.popup({maxWidth:270,minWidth:230,className:"horizon-popup",closeButton:!1,offset:[0,-6]}).setContent(`
      ...
      `})]})}export{E as default};
//# sourceMappingURL=BillboardMap-BSxLkpcR.js.map
